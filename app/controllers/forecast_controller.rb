class ForecastController < ApplicationController
  def index
    ...
    if @is_past_month
      ...
      @monthly_spending_chart_data = [ { name: I18n.t("forecast.index.actual_spending"), data: spending_data } ]
      @monthly_spending_chart_data << { name: I18n.t("forecast.index.income_line"), data: income_data } if @actual_income_total > 0
    else
      ...
      # Projected income: generated recurring copies + one-off incomes for this month
      @projected_incomes = current_user.incomes.for_month(@current_date)
      @projected_income = @projected_incomes.sum(:amount)
      ...
      @monthly_spending_chart_data << { name: I18n.t("forecast.index.income_line"), data: income_data } if @projected_income > 0
    end
